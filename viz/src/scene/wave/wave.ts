...
import vShader from "./wave.vs.glsl";
import fShader from "./wave.fs.glsl";

export class WaveScene extends ThreeScene {
    ...
    onBeat(b: any): void {
        console.log(b);
        this.material.uniforms.u_beat.value = this.now / 1000 + 100;
